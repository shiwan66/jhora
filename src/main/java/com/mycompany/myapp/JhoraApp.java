...
public class JhoraApp {

    private static final Logger log = LoggerFactory.getLogger(JhoraApp.class);

    private final Environment env;

    public JhoraApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhoraApp.class);
