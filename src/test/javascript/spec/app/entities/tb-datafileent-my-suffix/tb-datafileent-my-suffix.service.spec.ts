...
describe('Service Tests', () => {
    ...
    describe('TbDatafileentMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TbDatafileentMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tb-datafileents';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TbDatafileentMySuffix', () => {
