...
describe('Service Tests', () => {
    ...
    describe('TBdatafileMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TBdatafileMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/t-bdatafiles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TBdatafileMySuffix', () => {
