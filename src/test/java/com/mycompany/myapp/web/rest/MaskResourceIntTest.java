...
public class MaskResourceIntTest {
    ...
    private static final String DEFAULT_SJCD = "AAAAAAAAAA";
    private static final String UPDATED_SJCD = "BBBBBBBBBB";
    ...
    public void createMask() throws Exception {
        ...
        assertThat(testMask.getSjcd()).isEqualTo(DEFAULT_SJCD);
    ...
    public void getAllMasks() throws Exception {
        ...
        restMaskMockMvc.perform(get("/api/masks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].sjcd").value(hasItem(DEFAULT_SJCD.toString())))
    ...
    public void getMask() throws Exception {
        ...
        restMaskMockMvc.perform(get("/api/masks/{id}", mask.getId()))
            ...
            .andExpect(jsonPath("$.sjcd").value(DEFAULT_SJCD.toString()))
    ...
    public void updateMask() throws Exception {
        ...
        assertThat(testMask.getSjcd()).isEqualTo(UPDATED_SJCD);
